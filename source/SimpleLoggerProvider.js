...
define(["./SimpleLogger","./SimpleLogLevels"], 
   ...
   * @constructor
   * 
   * @class Simple LoggerProvider implementation that can be used to consume
   * {@link LoggerManager} logging. 
   * To enable client logging, an instance of this class has to be created and supplied through the
   * {@link LoggerManager.setLoggerProvider} method before any log can be 
   * consumed.
   * <br/>In order to determine how to consume the log, one or multiple "appenders"
   * can be supplied to this object, through {@link #addLoggerAppender}.
