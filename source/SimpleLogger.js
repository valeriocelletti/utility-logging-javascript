...
define(["./SimpleLogLevels"], function(SimpleLogLevels){
  ...
  SimpleLogger.prototype = {
     ...
     * lines may still be received by the {@link #fatal} method
     ...
     * lines may still be received by the {@link #error} method
     * and should be ignored by the Logger implementation. 
     * 
     ...
     * lines may still be received by the {@link #warn} method
     * and should be ignored by the Logger implementation. 
     * 
     ...
     * lines may still be received by the {@link #info} method
     * and should be ignored by the Logger implementation. 
     * 
     ...
     * lines may still be received by the {@link #debug} method
     * and should be ignored by the Logger implementation. 
     * 
